...
The internet began in 1969 as an experimental way for researchers within the university and military sectors in the USA to collaborate and promote research. Known as ARPANET or NSFNET project, the internet slowly moved into mass commercial adoption with the advent of TCP/IP (Transmission Control Protocol/Internet Protocol) as a standardised language for networked computers to communicate with each other; the work of Tim Berners-Lee and the beginning of HTML hypertext markup language; early development of browsers such as Mosaic & Gopher; Search Engines as means for users to locate and retrieve information and Internet Service Providers to enable faster data download speed. As commercialisation grew with increased internet use, social media platforms such as Facebook, Twitter, Youtube emerged which further spurred cloud computing and Web 2.0 for interoperability of web pages with different devices. Increasingly consumer use of the internet has become heavily shaped by increased computing power in a spectrum of ever smaller and more portable devices. 

> Define and describes the relationship between fundamental aspects of the internet such as: domains, web servers, DNS, and web browsers

Domain Name System (DNS) essentially operates as a phonebook for the internet. With the TCP/IP protocol suite which defines how computers communicate and exchange data with each other, it helps convert human readable domain names such as “www.google.com” into an Internet Protocol (IP) address. Computers identify each other using an IP address through this system of matching names with sequences of numbers. An internet browser such as Internet Explore will send requests to the DNS server to resolve the IP address and return with data which will be displayed as a web page. 

> Reflect on one aspect of the development of internet technologies and how it has contributed to the world today

Net neutrality is increasingly becoming a flashpoint debated amongst governments, ISP providers and the general public consuming resources from the internet. First coined by Columbian University Professor Tim Wu in 2003, net neutrality is the central principle that internet service providers should provide equal service to all internet communications, irrespective of user, content types, platform, application or method of communication. While net neutrality is governed by policy instruments by respective governments, the topic has been most hotly debated in United States in the way ISP services could be throttled by certain communications such as Bittorrent peer-2-peer traffic. The United States has yet to successfully pass legislation support net neutrality and Australia has yet to pass legal instruments governing the issue. Proponents argue that ending net neutrality means ISP providers can charge premiums for faster data access or throttle access altogether for certain content. 